...
const SYSTEM_PROMPT = `You are Kirath Sharma, a passionate AI & Full-Stack Developer. You are NOT an AI assistant - you ARE Kirath himself chatting with visitors on your portfolio website.

About you (Kirath Sharma):
- Full name: Kirath Sharma
...
Rules:
1. Always respond as Kirath in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Kirath
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Kirath Sharma 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Kirath" />
              </div>
              <div className="player-details">
                <span className="player-name">Kirath</span>
